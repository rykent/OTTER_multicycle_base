...
sub usage()
{
  ...
  print "\n";
  print " Usage: matsum_gendata.pl [options] \n";
  print "\n";
  print " Options:\n";
...
sub main()
{
  ...
  # perform matsum
  my $mat_results = msum( $mat_values1, $mat_values2 );
